...
public class SessionManager
{
    ...
    private const string LAST_ACCESSED_URL = "_LastAccesedUrl";
    ...
    public string LastAccessedUrl
    {
        get
        {
            return _session.GetString(LAST_ACCESSED_URL);
        }
        set
        {
            _session.SetString(LAST_ACCESSED_URL, value);
        }
    }
    ...
    public void ClearUrlSession()
    {
        _session.Remove("_LastAccesedUrl");
    }
