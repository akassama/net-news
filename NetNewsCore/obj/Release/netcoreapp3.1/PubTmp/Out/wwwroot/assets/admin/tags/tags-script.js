...
document.getElementById('getTags').addEventListener('click', function(e) {
  e.preventDefault();
  alert(tags.getTags());
});
document.getElementById('clearTags').addEventListener('click', function(e) {
  e.preventDefault();
  tags.clearTags();
});
document.getElementById('addTags').addEventListener('click', function(e) {
  e.preventDefault();
  tags.addTags('New');
});
document.getElementById('addArrTags').addEventListener('click', function(e) {
  e.preventDefault();
  tags.addTags(['Net News', 'Latest News', 'The Gambia']);
});
document.getElementById('destroyTags').addEventListener('click', function(e) {
  e.preventDefault();
