$(".imgAdd").click(function () {
    $(this).closest(".row").find('.imgAdd').before('<div class="col-sm-12 col-md-6 col-lg-4 mb-5 imgUp"><div class="imagePreview"></div><div class="form-group"><input type="text" class="form-control alpha-only" name="ImgCaption" id="ImgCaption" maxlength="250" value="#caption" placeholder="caption" required></div><label class="btn btn-success btn-block"> <i class="fas fa-image"></i> Select<input type="file" class="uploadFile img" name="PostImages" id="PostImages" value="Upload Photo" accept="image/*"></label><i class="fa fa-times ImageAction del"></i></div>');
});
