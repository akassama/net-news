...
namespace NetNews.Controllers
{
    public class LatestNewsController : Controller
    {
        ...
        public LatestNewsController(DBConnection context, ILogger<LatestNewsController> logger, IOptions<SystemConfiguration> systemConfiguration, 
            IWebHostEnvironment hostingEnvironment, IDetectionService detectionService, IHttpContextAccessor accessor, SessionManager sessionManager)
        {
            _context = context;
            _logger = logger;
