...
namespace NetNews.Controllers
{
    public class VideosController : Controller
    {
        ...
        public VideosController(DBConnection context, ILogger<VideosController> logger, IOptions<SystemConfiguration> systemConfiguration, IDetectionService detectionService, IHttpContextAccessor accessor, SessionManager sessionManager)
        {
            _context = context;
            _logger = logger;
